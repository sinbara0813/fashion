...
import com.d2cmall.buyer.adapter.AloneAdapter;
...
public class AloneSubFragment extends BaseFragment {
    ...
    private AloneAdapter flashBuyAdapter;//列表所用的adapter,抢大牌和商品限时购都是用这个adapter
    ...
    public static AloneSubFragment newInstance(int promotionId, int type,long start,long end) {
        //传入promotionId和用来区别抢大牌和限时购的type
        AloneSubFragment flashProductSubFragment = new AloneSubFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        startTime=getArguments().getLong("start");
        endTime=getArguments().getLong("end");
    }
    ...
    public void prepareView() {
        ...
        j = 0;
        p = 1;
        flashBuyAdapter = new AloneAdapter(mContext,list,startTime,endTime);
        if (type == 1) {
    ...
    public boolean canRefresh(){
        if (recycleView==null){
            ...
            return !recycleView.canScrollVertically(-1);
        }
    }
