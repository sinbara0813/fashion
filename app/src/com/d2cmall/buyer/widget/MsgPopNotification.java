 ...
 * 消息弹窗
 */
public class MsgPopNotification {
    ...
    public MsgPopNotification(Builder builder) {
        ...
        mWindowParams.width = ScreenUtil.dip2px(336);
        mWindowParams.height = ScreenUtil.dip2px(64);
        mWindowParams.flags =
        ...
        mWindowParams.x = 0;
        mWindowParams.y = -mStatusBarHeight+ ScreenUtil.dip2px(12);
     ...
     * @param context
     */
    private void setContentView(final Context context, Builder builder) {
        mContentView = LayoutInflater.from(context).inflate(R.layout.layout_pop_msg, null);
...
//    }
    ...
    public static class Builder {
        ...
        public MsgPopNotification build() {

            if (null == context)
                throw new IllegalArgumentException("the context is required.");

            return new MsgPopNotification(this);
        }
