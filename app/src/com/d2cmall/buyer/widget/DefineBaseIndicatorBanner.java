 ...
 */
public abstract class DefineBaseIndicatorBanner<E, T extends DefineBaseIndicatorBanner<E, T>> extends DefineBaseBanner<E,T> {
    ...
    public DefineBaseIndicatorBanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.flyco.banner.R.styleable.BaseIndicatorBanner);
        mIndicatorStyle = ta.getInt(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorStyle, STYLE_CORNER_RECTANGLE);
        mIndicatorWidth = ta.getDimensionPixelSize(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorWidth, dp2px(6));
        mIndicatorHeight = ta.getDimensionPixelSize(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorHeight, dp2px(6));
        mIndicatorGap = ta.getDimensionPixelSize(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorGap, dp2px(6));
        mIndicatorCornerRadius = ta.getDimensionPixelSize(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorCornerRadius, dp2px(3));
        mSelectColor = ta.getColor(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorSelectColor, Color.parseColor("#ffffff"));
        mUnselectColor = ta.getColor(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorUnselectColor, Color.parseColor("#88ffffff"));

        int selectRes = ta.getResourceId(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorSelectRes, 0);
        int unselectRes = ta.getResourceId(com.flyco.banner.R.styleable.BaseIndicatorBanner_bb_indicatorUnselectRes, 0);
        ta.recycle();
