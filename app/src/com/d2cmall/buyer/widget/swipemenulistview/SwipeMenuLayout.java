package com.d2cmall.buyer.widget.swipemenulistview;
...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public SwipeMenuLayout(View contentView, SwipeMenuView menuView,
        ...
        middleView = mContentView.findViewById(R.id.middle_ll);
        mMenuView = menuView;
    ...
    private void swipe(int dis) {
        ...
        middleView.layout(-dis, middleView.getTop(),
                middleView.getWidth() - dis, middleView.getBottom());

        if (mSwipeDirection == SwipeMenuListView.DIRECTION_LEFT) {

            mMenuView.layout(middleView.getWidth() - dis, middleView.getTop(),
                    middleView.getWidth() + mMenuView.getWidth() - dis,
                    middleView.getBottom());
        } else {
    ...
    public void smoothOpenMenu() {
        ...
        state = STATE_OPEN;
        if (mSwipeDirection == SwipeMenuListView.DIRECTION_LEFT) {
            mOpenScroller.startScroll(-middleView.getLeft(), 0, mMenuView.getWidth(), 0, 350);
        } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mMenuView.measure(MeasureSpec.makeMeasureSpec(0,
                ...
                middleView.getMeasuredHeight(), MeasureSpec.EXACTLY));
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mSwipeDirection == SwipeMenuListView.DIRECTION_LEFT) {
            mMenuView.layout(getMeasuredWidth(), middleView.getTop(),
