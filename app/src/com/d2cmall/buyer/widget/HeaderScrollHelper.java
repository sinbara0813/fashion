...
public class HeaderScrollHelper {
    ...
    public boolean isTop() {
        ...
        if (scrollableView instanceof StaggeredGridView) {
            return isStaggeredGridViewTop((StaggeredGridView) scrollableView);
        }
    ...
    private boolean isRecyclerViewTop(RecyclerView recyclerView) {
        if (recyclerView != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (childAt == null || (firstVisibleItemPosition == 0 && childAt.getTop() == 0)||firstVisibleItemPosition==-1) {
                    return true;
                }
            }
        }
    ...
    private boolean isStaggeredGridViewTop(StaggeredGridView staggeredGridView) {
        boolean result = false;
        View v = staggeredGridView.getChildAt(0);
