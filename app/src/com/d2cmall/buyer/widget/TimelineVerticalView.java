 ...
 */
public class TimelineVerticalView extends View {
    ...
    public TimelineVerticalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, ScreenUtil.dip2px(20));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, ScreenUtil.dip2px(20));
        ...
        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(R.drawable.bg_gray_dot);
        }
