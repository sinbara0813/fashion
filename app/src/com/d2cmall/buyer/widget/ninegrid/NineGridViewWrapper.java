...
public class NineGridViewWrapper extends ImageView {
    ...
    private float textSize = 15;          //显示文字的大小单位sp
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (moreNum > 0) {
            ...
            Rect rect1=new Rect();
            textPaint.getTextBounds("更多",0,2,rect1);

            String numStr="+"+moreNum;
            Rect rect2=new Rect();
            textPaint.getTextBounds(numStr,0,numStr.length(),rect2);

            canvas.drawText("更多",getWidth()/2,(getHeight()-rect2.height()-10)/2,textPaint);
            canvas.drawText(numStr,getWidth()/2,(getHeight()-rect2.height()+10)/2+rect1.height(),textPaint);
        }
    }
