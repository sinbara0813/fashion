package com.d2cmall.buyer.widget.heartLayout;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    public void setDrawables(int []drawables1){
        if(drawables1==null||drawables1.length==0){
            return;
        }
        drawables=new Drawable[drawables1.length];
        for(int i=0;i<drawables.length;i++){
            Drawable drawable=getResources().getDrawable(drawables1[i]);
