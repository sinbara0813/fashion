...
public class NiceVideoPlayer extends FrameLayout
    ...
    private MyNiceTextureView mTextureView;

    public TxVideoPlayerController getmController() {
        return mController;
    }
    ...
    private void initTextureView() {
        if (mTextureView == null) {
            mTextureView = new MyNiceTextureView(mContext);
    ...
    public void enterFullScreen() {
        ...
        LogUtil.d("PLAYER_FULL_SCREEN"+ ScreenUtil.getDisplayWidth());
    }
    ...
    public int getVisibilityPercents() {
        ...
        this.getLocalVisibleRect(mCurrentViewRect);
    ...
    public void preStart(){
        if (mController!=null&&mController.mCenterStart!=null){
            mController.mCenterStart.performClick();
        }
    }
}
