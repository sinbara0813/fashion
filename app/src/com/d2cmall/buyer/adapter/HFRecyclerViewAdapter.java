...
public class HFRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    /*public HFRecyclerViewAdapter(RecyclerView recyclerView, RecycleScroller recycleScroller) {
        recyclerView.addOnScrollListener(new RecycleScrollListener(recycleScroller));
    }*/
    ...
    public void setAdapter(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        ...
        if (adapter != null) {
            if (!(adapter instanceof RecyclerView.Adapter))
                throw new RuntimeException("your adapter must be a RecyclerView.WardrobeVpAdapter");
        }
