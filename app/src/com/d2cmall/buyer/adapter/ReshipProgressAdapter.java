 ...
 */
public class ReshipProgressAdapter extends RecyclerView.Adapter<ReshipProgressAdapter.TimeLineViewHolder> {

    private Context mContext;
    private boolean mWithLinePadding;
    private LayoutInflater mLayoutInflater;
    private List<RefundBeanData.DataBean.ReshipLogsBean> logs;

    public ReshipProgressAdapter(Context context, boolean withLinePadding, List<RefundBeanData.DataBean.ReshipLogsBean> logs) {
