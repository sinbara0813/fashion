...
public class CouponRelationBrandsProductAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<ProductDetailBean.DataBean.ProductBean> products;
    public CouponRelationBrandsProductAdapter(Context context, List<ProductDetailBean.DataBean.ProductBean> products) {
        mContext=context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final ProductDetailBean.DataBean.ProductBean productsBean = products.get(position);
        UniversalImageLoader.displayImage(mContext,productsBean.getImg(),focusBrandItem.mImage1);
        ...
        focusBrandItem.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id",Long.valueOf(productsBean.getId()));
