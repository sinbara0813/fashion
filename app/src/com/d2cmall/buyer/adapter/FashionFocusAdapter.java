 ...
 */
public class FashionFocusAdapter extends DelegateAdapter.Adapter {

    private Context mContext;
    private List<UnFollowBean.DataBean.ActiveMemberBean.ListBean> list;
    private UserBean.DataEntity.MemberEntity user;

    public FashionFocusAdapter(Context context, List<UnFollowBean.DataBean.ActiveMemberBean.ListBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 1) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.layout_textview, parent, false);
