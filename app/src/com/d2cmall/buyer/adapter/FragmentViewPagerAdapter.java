...
/**
 * 可缓存fragment对象的PagerAdapter
 * Author: Blend
 * Date: 2016/12/09 09:35
...
public class FragmentViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    ...
    private List<RefreshFragment> fragments; // 每个Fragment对应一个Page
    ...
    public FragmentViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager , List<RefreshFragment> fragments) {
