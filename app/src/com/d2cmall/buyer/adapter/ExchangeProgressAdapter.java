 ...
 */
public class ExchangeProgressAdapter extends RecyclerView.Adapter<ExchangeProgressAdapter.TimeLineViewHolder> {

    private Context mContext;
    private boolean mWithLinePadding;
    private LayoutInflater mLayoutInflater;
    private List<ExchangeProductDetialBean.DataBean.ExchangeLogsBean> logs;

    public ExchangeProgressAdapter(Context context, boolean withLinePadding, List<ExchangeProductDetialBean.DataBean.ExchangeLogsBean> logs) {
