...
import com.d2cmall.buyer.adapter.ImagePreviewAdapter;
...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setOffscreenPageLimit(imageInfo.size());
    ...
    public void onEvent(GlobalTypeBean bean) {
        if (bean.getType()==Constants.GlobalType.SAVETAG&&bean.getIntValue()!=1){
            finish();
        }
    }
