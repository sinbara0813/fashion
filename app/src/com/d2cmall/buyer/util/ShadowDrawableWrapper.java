...
public class ShadowDrawableWrapper extends android.support.v7.graphics.drawable.DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius,
        ...
        mShadowStartColor = ContextCompat.getColor(context, R.color.ShadowItem2);
        mShadowMiddleColor = ContextCompat.getColor(context, R.color.ShadowItem3);
        mShadowEndColor = ContextCompat.getColor(context, R.color.ShadowItem4);
