...
package google.zxing.client.camera;
...
public final class CameraManager {
    ...
    public synchronized void changeCameraId(SurfaceHolder holder) {
        //切换前后摄像头
        int cameraCount = 0;
    ...
    public synchronized void startPre() {
        camera.startPreview();
    }

    public synchronized void takePhoto(Camera.PictureCallback mPictureCallback) {
